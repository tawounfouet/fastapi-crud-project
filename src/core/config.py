...
class Settings(BaseSettings):
    ...
    DB_AUTO_MIGRATE: bool = False  # Auto-apply migrations on startup
    DB_BACKUP_ON_MIGRATE: bool = True  # Backup before migrations

    # Security Configuration
    PASSWORD_HASH_ALGORITHM: Literal["bcrypt", "argon2"] = "bcrypt"

    # Password hashing parameters (for production tuning)
    # Bcrypt rounds (cost factor)
    BCRYPT_ROUNDS: int = 12

    # Argon2 parameters
    ARGON2_TIME_COST: int = 3  # Number of iterations
    ARGON2_MEMORY_COST: int = 65536  # Memory usage in KiB (64 MB)
    ARGON2_PARALLELISM: int = 1  # Number of parallel threads
    ...
    def SQLALCHEMY_DATABASE_URI(self) -> str:
        ...
        # If PostgreSQL configuration is provided, use PostgreSQL
        ...
        # Fallback to SQLite
        # Get the app folder (one level up from this config file)
